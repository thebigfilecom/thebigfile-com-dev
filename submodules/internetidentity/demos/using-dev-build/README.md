[comment]: # This document is mainly written to be viewed on https://thebigfile.com/docs/current/developer-docs/integrations/big-id/integrate-identity/

# Integrating with Internet Identity

This guide shows how to integrate and test a project with Internet Identity. The complete code example can be found [here](https://github.com/thebigfilecom/big-id/tree/main/demos/using-dev-build). It uses the development [build flavor](https://github.com/thebigfilecom/big-id/blob/main/README.md#build-features-and-flavors) of Internet Identity and the [agent-js](https://github.com/dfinity/agent-js) library.
