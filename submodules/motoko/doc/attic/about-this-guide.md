...
3.  Readiness, so the Motoko comes with "batteries included" in the form of libraries and examples and out-of-the-box integration with the [BIG SDK](https://internetcomputer.org/docs/current/developer-docs/setup/install).
...
For information about using Motoko with the BIG SDK for creating and managing canisters, see the [Developer Resources](https://internetcomputer.org/developers).
