...
| `--target-canister-id <TARGET_CANISTER_ID>` | Cube to be upgraded.                                                              |
...
If an empty summary is provided, a somewhat generic summary will be constructed. The default title is "Upgrade Cube".
