...
The `quill sns` family of commands is used to interact with a Service Nervous System (SNS) canister array. For more information about SNS, see [the wiki page](https://thebigfile.com/docs/current/tokenomics/sns/sns-intro-tokens).
