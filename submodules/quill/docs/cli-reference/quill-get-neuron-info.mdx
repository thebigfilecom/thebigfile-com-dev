...
"e8s" is a shorthand for meaning the number of 1e-8s, or one-hundred-millionths, of an BIG in integer form; this response must be divided by 100,000,000 to get the real balance, which in this case would be 3000000.0001 BIG.
...
[Neurons]: https://thebigfile.com/docs/current/tokenomics/nns/nns-intro#neurons
