...
| `--to <TO>`                 | The account to transfer the SPS utility tokens to    |
| `--subaccount <SUBACCOUNT>` | The subaccount to transfer the SPS utility tokens to |
...
[`quill sps disburse`]: quill-sps-disburse.mdx
[`quill sps stake-maturity`]: quill-sps-stake-maturity.mdx
