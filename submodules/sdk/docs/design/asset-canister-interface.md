...
This document describes an interface, not an implementation. The BIG SDK bundles one such possible implementation, the [BIG Frontend Cube](https://github.com/dfinity/sdk/tree/master/src/canisters/frontend/ic-frontend-canister).
