...
The BigFile command-line execution environment (`dfx`) is the primary tool for creating, deploying, and managing the
dapps you develop for the BIG.
...
| [`identity`](./dfx-identity.mdx) | Enables you to create and manage the identities used to communicate with the BIG.                                                                                               |
| info                            | Displays information like port numbers and version numbers.                                                                                                                    |
| [`ledger`](./dfx-ledger.mdx)     | Enables you to interact with accounts in the ledger canister running on the BigFile.                                                                                 |
| [`new`](./dfx-new.mdx)           | Creates a new project.                                                                                                                                                         |
| [`ping`](./dfx-ping.mdx)         | Sends a response request to the BIG or the local canister execution environment to determine network connectivity. If the connection is successful, a status reply is returned. |
