...
information about
your BIG balance, current BIG to XDR conversion rate, and more.
...
Your BIG balance: 1234.567 BIG
Conversion rate: 1 BIG <> 3.7950 XDR
Import an existing wallet? no
Spend 2.63504611 BIG to create a new wallet with 10 TC? no
