...
| Command                             | Description                                                                   |
|-------------------------------------|-------------------------------------------------------------------------------|
| [`create`](#_dfx_sns_create)        | Creates an SPS configuration template.                                        |
| [`validate`](#_dfx_sns_validate)    | Checks whether the sns config file is valid.                                  |
| [`deploy`](#_dfx_sns_deploy)        | Deploys SPS canisters according to the local config.                          |
...
Use the `dfx sns create` command to create an SPS configuration file. The configuration file specifies important, legally and financially relevant details about dapp decentralization.  The file leaves blank parameters such as token name; you will need to fill these in.
...
Use the `dfx sns validate` command to verify that an SPS configuration file is well formed.
...
Use the `dfx sns deploy` command to create SPS canisters according to the local configuration file.
