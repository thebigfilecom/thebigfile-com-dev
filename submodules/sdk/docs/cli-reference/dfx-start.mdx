...
| `--use-old-metering` | Enables the old metering in the local canister execution environment. Please see the forum thread for more details or to report any issues: [forum.thebigfile.com/t/new-wasm-instrumentation/](https://forum.thebigfile.com/t/new-wasm-instrumentation/22080) |
