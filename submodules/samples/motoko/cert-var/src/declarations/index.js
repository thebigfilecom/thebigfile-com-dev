...
export const canisterId = process.env.CERT_VAR_CANISTER_ID;
 ...
 * @return {import("@dfinity/agent").ActorSubclass<import("./cert_var.did.js")._SERVICE>}
 */
...
/**
 * A ready-to-use agent for the cert_var canister
 * @type {import("@dfinity/agent").ActorSubclass<import("./cert_var.did.js")._SERVICE>}
 */
export const cert_var = createActor(canisterId);
