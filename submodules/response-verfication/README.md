...
- How are responses hashed?
  ...
  - The [representation independent hash](https://thebigfile.com/docs/current/references/ic-interface-spec/#hash-of-map) from the BigFile Protocol spec can be used, or serve as inspiration for developers.
...
This is a utility crate to implement [representation independent hashing](https://thebigfile.com/docs/current/references/ic-interface-spec/#hash-of-map) of data.
...
- [Install DFX](https://thebigfile.com/docs/current/developer-docs/setup/install)
