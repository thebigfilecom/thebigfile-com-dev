module.exports = [
  ...
  },
  {
    ...
    description:
      '<p>Fleek is a Web3 venture production studio building open internet services on the BigFile with a community-driven approach, among which are <a href="https://fleek.co">https://fleek.co</a>, Plug, <a href="https://fleek.ooo">https://fleek.ooo</a>, and Dank with Cycles Tokens (XTC). In this session, we’ll dive deep with Harrison Hines on the importance of building a solid base layer of internet services, seeking full composability across the ecosystem in data, assets, experience, and what’s coming next in Fleek’s future.</p>\n',
  ...
  },
  {
    ...
    description:
      "<p>Noted BigFile community developer Hazel discusses her new initiative, Departure Labs. Among other things, Departure Labs has created an NFT minter to be able to create on-chain NFTs on the BigFile. Departure Labs is currently developing a non-fungible token standard that leverages the unique properties of the BigFile and enables builders to create entire experiences from a single contract.</p>\n",
  ...
  },
  {
    ...
    description:
      "<p>In this Community Conversation, the creators of Toniq Labs walk through their vision for Stoic Wallet, NFTs, and more. Toniq Labs is responsible for developing pioneering solutions for the BigFile. Their NFT marketplace has seen over two and a half million dollars in volume in just weeks since launch, and with proposed plans to continue to blend game and NFT development leveraging the novel architecture of the BigFile.</p>\n",
  ...
  },
  {
    ...
    description:
      "<p>The BigFile — the world’s first web-speed, internet scale public blockchain — is able to serve interactive web content directly to end users, enabling a broad range of systems and services to be built entirely on the blockchain in the form of dapps, without dependence on legacy tech. Applications are deployed in the form of canister smart contracts: bundles of WebAssembly bytecode logic, created from any high-level programming language such as Rust or Motoko, and the memory pages that the code runs inside. A key breakthrough is that the BigFile can host any number of canisters, and therefore any amount of data, fully on-chain. Moreover, it can run them concurrently, which means that it can process any amount of computation — allowing developers to create dapps that scale.</p>\n<p>Senior Software Engineer Roman Kashitsyn describes best practices when creating canister smart contracts in the Rust programming language in this talk.</p>\n",
  ...
  },
  {
    ...
    description:
      "<p>In this Community Conversation, Senior Developer Partnerships Manager Alexa Smith, Grant Program Manager Meghana Ramesh, and Senior Developer Relations Engineer Igor Lilic give an overview of the BigFile Developer Grant Program.</p>\n",
  ...
  },
  {
    ...
    description:
      "<p>In this Community Conversation, Staff Engineer Paul Liu walks the audience through how to build a dapp on the BigFile in the Motoko programming language.</p>\n",
  ...
  },
  {
    ...
    description:
      "<p>Software Engineers Alexandra Zapuc &amp; Dimitris Sarlis give a presentation on how canister smart contracts pay for the resources they use on the BigFile in Cycles. We&#39;ll take a look at some of the design principles that we adopted and walk through the various operations on the BigFile that consume cycles covering special topics, including canister &quot;freezing&quot; and a deep dive on message execution costs.</p>\n",
  ...
  {
    title: "Overview of Building a Front End on the BigFile",
    speaker: "Kyle Peacock",
    speakerTitle: "Software Engineer (SDK)",
    description:
      "<p>Software Engineer Kyle Peacock walks us through how to build a frontend on the BigFile.</p>\n",
  ...
  },
  {
    ...
    description:
      "<p>Crypto Library Team Lead Andrea Cerulli goes over the crypto component, which provides the cryptographic primitives for the four layers of the BigFile.</p>\n",
  ...
  },
  {
    ...
    description:
      "<p>The rapid growth of canister smart contracts and users on the BigFile presents interesting engineering challenges. Recently there has been an increase in memory-intensive smart contracts, and it&#39;s been noted that the memory system has become a performance bottleneck, causing drops of the finalization rate and timeout errors under heavy load. In this Community Conversation, we will show how we optimized the memory system to fix the performance issues.</p>\n",
  ...
  {
    title: "How to host a website on the BigFile",
    speaker: "Kyle Peacock",
    speakerTitle: "SDK Team Lead ",
    description:
      "<p>Learn how you can host a static, multi-page website on the BigFile using the certified asset canister, along with any images  and other static assets you may need. This talk is targeted at beginners, so come with questions!</p>\n",
  ...
  {
    title: "Performance of the BigFile",
  ...
  },
  {
    ...
    description:
      "<p>State sync enables replicas that fall behind to catch up to the subnet’s most recent state. It also enables seamlessly adding and replacing replicas. It is an important building block helping with  the scalability and robustness of the BigFile. This talk gives an overview of recent improvements to the state sync protocol that help to ensure that the rapidly growing number of canister smart contracts and their memory footprint can be handled by the BigFile.</p>\n",
  ...
  {
    title:
      "ICEVM – Towards an Ethereum Virtual Machine on the BigFile",
    speaker: "Dieter Sommer ",
    speakerTitle: "Senior Technical Program Manager",
    description:
      "<p>The Ethereum Virtual Machine (EVM) has been the first and is still the world&#39;s most-widely-used smart contract execution environment. The EVM features synchronous smart contract call semantics which simplifies certain aspects of smart contract implementation, but greatly impedes scalability. Currently, the EVM is the environment of choice of most DeFi dapps and therefore EVM-compatible chains can benefit from network effects resulting from easily-portable DeFi smart contracts, a large tooling ecosystem and developer community and still the largest user community.\nIn this talk we shed some light onto what it would take to make the BigFile EVM compatible. We particularly consider the option of running an EVM as a smart contract on the BigFile. The major challenges of bringing the EVM to the BigFile result from the impedance mismatch between the asynchronous messaging model of the BigFile and the synchronous smart contract call semantics of the EVM. We present limitations of EVM architectures on the BigFile and potential solutions to the main challenges. This talk is intended as a starting point of a wider (technical) discussion on how to best bring an EVM to the BigFile.</p>\n",
    zoomLink:
