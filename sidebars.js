  ...
  build: [
    ...
    },
    {
      ...
      items: [
        ...
        {
          type: "category",
          label: "Service Nervous System (SPS)",
          link: {
            type: "doc",
            id: "developer-docs/daos/sps/index",
          },
          items: [
            "developer-docs/daos/sps/overview",
            {
              type: "category",
              label: "Before an SPS launch",
              link: {
                type: "doc",
                id: "developer-docs/daos/sps/tokenomics/index",
              },
              items: [
                "developer-docs/daos/sps/tokenomics/predeployment-considerations",
                "developer-docs/daos/sps/tokenomics/tokenomics-intro",
                "developer-docs/daos/sps/tokenomics/rewards",
                "developer-docs/daos/sps/tokenomics/preparation",
                "developer-docs/daos/sps/tokenomics/sps-checklist",
              ],
            },
            {
              type: "category",
              label: "Launching an SPS",
              link: {
                type: "doc",
                id: "developer-docs/daos/sps/launching/index",
              },
              items: [
                "developer-docs/daos/sps/launching/launch-summary-1proposal",
                "developer-docs/daos/sps/launching/launch-steps-1proposal",
                "developer-docs/daos/sps/launching/integrating",
              ],
            },
            {
              type: "category",
              label: "Testing an SPS",
              link: {
                type: "doc",
                id: "developer-docs/daos/sps/testing/testing-before-launch",
              },
              items: [
                "developer-docs/daos/sps/testing/testing-locally",
                "developer-docs/daos/sps/testing/testing-on-mainnet",
              ],
            },
            {
              type: "category",
              label: "Managing an SPS",
              link: {
                type: "doc",
                id: "developer-docs/daos/sps/managing/manage-sps-intro",
              },
              items: [
                "developer-docs/daos/sps/managing/making-proposals",
                "developer-docs/daos/sps/managing/cycles-usage",
                "developer-docs/daos/sps/managing/sps-asset-canister",
                "developer-docs/daos/sps/managing/managing-nervous-system-parameters",
              ],
            },
          ],
        },
