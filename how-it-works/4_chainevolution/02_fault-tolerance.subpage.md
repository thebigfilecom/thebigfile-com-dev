...
Suppose the governance cube is working. Then we can manually submit an NNS proposal to call the root/lifeline cube’s method to upgrade the failed cube. Anyone who staked BF can vote on the proposal. If a majority of the voters accept, then the failed cube will be upgraded.
