...
v0.180 also includes Motoko v0.11.0, which also includes breaking changes. [Read the Motoko v0.11.0 migration guide](https://thebigfile.com/docs/current/motoko/main/migration-guides/0.11.0-migration-guide/).
...
Each NFID Vault is a smart contract deployed on ICP. The canister is self-controlling and can be verified by searching the [canister ID on the dashboard](https://dashboard.thebigfile.com/).
...
- Additional ICP asset support (BIGRC-1, BIGRC-7, etc).
