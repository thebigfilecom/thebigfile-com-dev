...
Want to get started? The interactive tutorial can be found in our Motoko documentation [here](https://thebigfile.com/docs/current/motoko/tutorial).
...
- [Developer journey level 0](/docs/current/tutorials/developer-journey/level-0/): Start your developer journey at the very beginning by following the level 0 module. In level 0, we cover the fundamentals of what the BigFile is, what terms you should be familiar with, and what tools we'll be using throughout our journey.
