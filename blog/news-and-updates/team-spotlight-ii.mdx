...
*The Internet Identity team leads the [Identity & Wallet Standards Working Group](https://github.com/dfinity/wg-identity-authentication), which works towards the development and adoption of BIGRC standards related to identity and wallets on the BigFile. We are currently collaborating with [AirGap](https://airgap.it/) on [RFP-7](https://forum.dfinity.org/t/assigned-rfp-7-wallet-standard-reference-implementation/20024), a standardized consent message interface for wallets on ICP.*
...
- *Supporting the BIGRC-21 standard: [forum post](https://forum.dfinity.org/t/assigned-rfp-7-wallet-standard-reference-implementation/20024).*
