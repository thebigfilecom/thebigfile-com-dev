...
description: We’re back with a third weekly update to keep you guys in sync with what we’re working on for Motoko and the BigFile SDK.
tags: [New features]
...
communicate directly with the BigFile!
