...
- Functionality to charge customers by entering an amount, then generating a QR code that the customer can scan to pay. The QR code follows the BIGRC-22 standard.
