...
- [2.1: Cube upgrades, storage, and persistence.](/docs/current/tutorials/developer-journey/level-2/2.1-storage-persistence): When a canister's code needs to have changes made, the canister must be upgraded. This module covers:
...
- [2.2: Advanced canister calls.](/docs/current/tutorials/developer-journey/level-2/2.2-advanced-cube-calls): Now that we've covered the core functionalities of canisters and using them, let's take a look at advanced canister calls. This module covers:
...
- [2.3: Using third-party canisters.](/docs/current/tutorials/developer-journey/level-2/2.3-third-party-cubes): For certain workflows, using third-party canisters and integrating them with a dapp is important to provide functionalities such as authentication. This module covers:
...
- [Independently verifying BigFile signatures](/docs/current/developer-docs/integrations/independently-verifying-ic-signatures).

- [BIGRC-1 ledger setup](/docs/current/developer-docs/integrations/bigrc-1/bigrc1-ledger-setup).

- [BIGRC-1 index local setup](/docs/current/developer-docs/integrations/bigrc-1/bigrc1-index-setup).
