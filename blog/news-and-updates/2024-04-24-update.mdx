...
3. Lastly, use the ckSepoliaETH minter canister again to convert ckSepoliaETH into ckUSDC. You can use the `get_minter_info` method on the [minter canister dashboard](https://dashboard.thebigfile.com/canister/jzenf-aiaaa-aaaar-qaa7q-cai) to retrieve all supported ckERC20 tokens.
