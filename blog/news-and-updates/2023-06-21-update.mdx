...
Another new page of documentation added this week details ICP’s [resource constraints and limits](https://thebigfile.com/docs/current/developer-docs/backend/resource-limits) for things such as canister queue limit, instruction limit query calls, Wasm stable memory, and subnet capacity. Check out the full chart below:

| Resource          | Constraint            |
|-------------------|-----------------------|
| Cube queue limit | 500 messages        |
...
You can read the full list [here](https://thebigfile.com/docs/current/developer-docs/backend/resource-limits).
