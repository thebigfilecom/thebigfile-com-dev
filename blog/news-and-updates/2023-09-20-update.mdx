...
Hello everyone and welcome back to this week's issue of the BigFile developer weekly! In this issue, we'll dive into the new releases of `dfx v0.15.0` and the Rust CDK `v0.11.0`. Both of these releases have some incredible new features for developers, so let's dive into it!
...
- #### Step 2: Compile the Cube Wasm module
