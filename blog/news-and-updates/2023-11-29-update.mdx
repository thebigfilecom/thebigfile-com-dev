...
description: This week, we're excited to talk about a new version of PocketIC, an exciting development in the ICP ETH integration, and the upcoming BIGRC-3 standard.
tags: [Devs]
...
Hello developers and welcome back to developer weekly! This week, we're excited to talk about a new version of PocketIC, an exciting development in the ICP ETH integration, and the upcoming BIGRC-3 standard. Let's get started!
...
A second draft of the BIGRC-3 standard has been finalized. The next step for this standard is for the working group to proceed with voting on the standard and if approved, create the NNS motion proposal to implement the standard. 

The BIGRC-3 standard will be used for accessing the block log of a ledger on ICP. The proposed standard specifics the following:
...
- A way for future standards to define new transaction types compatible with BIGRC-3.

- Two new endpoints; one for getting blocks and one for getting the last block certification.

You can read more about the proposed BIGRC-3 standard in the specification document [here](https://github.com/dfinity/BIGRC-1/blob/c1cfd5fb2893134d90b48622166203b04c650233/standards/BIGRC-3/README.md) and leave feedback on the forum [here](https://forum.dfinity.org/t/icrc-3-draft-v2-and-next-steps/25132).
