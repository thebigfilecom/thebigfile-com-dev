...
The first goal of the working group will be to agree on a set of BIGRC standards pertaining to the publish / subscribe event model, then create a series of libraries that adhere to these standards.
...
An exciting community project has been shared on the forum! This project, titled BIG-SIWS, is designed to provide a way for Solana wallets to be used to authenticate on ICP. Here's a quick breakdown of how to use it:

Edit your project's `dfx.json` file to include the BIG-SIWS canister:
