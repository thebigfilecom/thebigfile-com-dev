...
Want to take a sneak peek? Check out [this tutorial](https://kyle-peacock.com/blog/dfinity/ic-expo/) that creates a React Native app on BIG that manually installs and configures the `@noble/curves` package. In the future, this dependency can be managed by npm instead.
