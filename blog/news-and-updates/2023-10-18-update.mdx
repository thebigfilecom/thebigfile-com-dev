...
Try it yourself on the [developer docs](https://thebigfile.com/docs/current/developer-docs/) by clicking the 'Ask AI' button! 
...
- [3.4 Introduction to agents.](/docs/current/tutorials/developer-journey/level-3/3.4-intro-to-agents): On the BigFile, an **agent** is a library used to make calls to ICP's public interface. This module covers:
