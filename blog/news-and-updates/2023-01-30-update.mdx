...
There’s a new kid on the block - @rvanasa just released a new JavaScript library for interacting with BigFile.
From the repository description,
The ic0 package is a simple, straightforward way to interact with canisters running on the BigFile (ICP).
