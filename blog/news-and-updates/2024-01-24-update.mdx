...
- [1: What is the BigFile?](/docs/current/tutorials/hackathon-prep-course/what-is-bigfile).
...
The latest version of the BIG replica contains an important update that enables P2P implementation for tECDSA and HTTPS outcalls! The following technological improvements are included in this update:
