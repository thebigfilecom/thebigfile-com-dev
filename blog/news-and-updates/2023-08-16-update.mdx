...
- 2.3: Cube query and update methods.
...
- 5.2: Creating your own BIGRC-1 token with Rosetta.
...
The first portion of this series, Level 0: Pre-flight operations, is out now and ready for you to follow along with! You can get started with your developer journey [here](https://thebigfile.com/docs/current/tutorials/developer-journey//level-0/).
...
You can find the full documentation with examples [here](https://thebigfile.com/docs/current/motoko/main/getting-started/motoko-introductionmo-doc).
