...
You can learn more about the Motoko VS Code extension [here](https://thebigfile.com/docs/current/developer-docs/setup/vs-code).
...
For more information on `dfx nns` and `dfx sns`, please see the reference documentation [here](https://thebigfile.com/docs/current/developer-docs/developer-tools/cli-tools/cli-reference/dfx-nns)
