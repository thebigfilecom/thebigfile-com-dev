...
The ledger canister is initialized using administrative operations that are internal to the BigFile. As part of the initialization process, the canister is created with the set of accounts and associated ICP token balances.
