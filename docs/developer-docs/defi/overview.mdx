...
The BigFile utilizes two different types of ledgers. The first ledger is the ICP ledger. It is part of the [NNS](/docs/current/developer-docs/daos/nns/overview) and the canister that implements
...
There is only one ICP ledger on the BigFile.
...
## Index canisters
The ICP ledger lets you query created blocks through various endpoints. See the documentation on [how to interact with the ICP ledger for more info](/docs/current/developer-docs/defi/big-tokens/using-the-ledger). If your ICRC-1 ledger supports the extension standard ICRC-3, then your ICRC-1 ledger will have an endpoint to serve transactions.
