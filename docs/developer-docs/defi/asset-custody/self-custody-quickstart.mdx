...
For information about the Network Nervous System, see [understanding the Internet Computer’s Network Nervous System, neurons, and BIG utility tokens](https://medium.com/dfinity/understanding-the-internet-computers-network-nervous-system-neurons-and-icp-utility-tokens-730dab65cae8).
