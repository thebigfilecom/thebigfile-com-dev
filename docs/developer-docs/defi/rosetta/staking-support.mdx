...
This document specifies extensions of the Rosetta API enabling staking funds and managing governance "neurons" on the BigFile.
  ...
  "operations": [
    {
      ...
      "amount": {
        "value": "-100000000",
        "currency": { "symbol": "BIG", "decimals": 8 }
      }
    },
    {
...
The command has two forms: one form accepts an [BIG principal](/references/ic-interface-spec.md#principal) as a hotkey, another form accepts a [public key](https://www.rosetta-api.org/docs/models/PublicKey.html).
...
-   The parent neuron has at least 1 BIG worth of maturity.
