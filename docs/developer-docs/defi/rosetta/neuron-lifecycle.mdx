...
For more information on neuron state transitions and rewards, see [understanding the BigFile’s Network Nervous System, neurons, and BIG utility tokens](https://medium.com/dfinity/understanding-the-internet-computers-network-nervous-system-neurons-and-icp-utility-tokens-730dab65cae8).
