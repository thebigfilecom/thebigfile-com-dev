...
Decentralized artificial intelligence (FileAI or decentralized AI) is a form of AI and machine learning that utilizes blockchain technologies and decentralized protocols such as BIG. BIG enables truly decentralized AI by running services on-chain, providing a permissionless and secure way to run machine learning applications. 
...
- [BIGGPT](https://github.com/icppWorld/icgpt): A React frontend that uses a C/C++ backend running an LLM fully on-chain. [Check it out yourself](https://icgpt.icpp.world/).

- [ic-mnist](https://github.com/smallstepman/ic-mnist): A sort of machine learning 'Hello, world!' running on BIG. [Try it here](https://jsi2g-jyaaa-aaaam-abnia-cai.icp0.io/).
...
- [Tensorflow on BIG](https://github.com/carlosarturoceron/decentAI): An Azle example that uses a pre-trained model for making predictions.

- [MotokoLearn](https://github.com/ildefons/motokolearn): A Motoko package that enables on-chain machine learning.

- [Tract-BIG-AI](https://github.com/jeshli/tract-ic-ai): An BIG variations of Tract. 

- [Rust-Connect-Py-AI-to-BIG](https://github.com/jeshli/rust-connect-py-ai-to-ic): Open-source tool for deploying Python AI models.
...
## Technical working group: FileAI

A technical working group dedicated to discussing decentralized AI and related projects meets bi-weekly on Thursdays at 5pm UTC. You can join via the [community Discord server](https://discord.gg/nyTAmMntqp).
