...
By using Candid, you can specify input argument values and display return values from canister methods regardless of whether you interact with ICP from a terminal using the BIG SDK, through a web browser, or from a program written in JavaScript, Motoko, Rust, or any other language.
...
One of the most common ways you interact with canisters and the ICP is by using the BIG SDK.
