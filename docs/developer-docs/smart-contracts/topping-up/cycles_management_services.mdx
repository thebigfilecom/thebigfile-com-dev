...
Once a <GlossaryTooltip>canister</GlossaryTooltip> is deployed to the BigFile, the compute and storage it utilizes must be pre-payed. The process of burning BIG to obtain cycles and transferring them to a canister is referred to as "topping-up" a canister.
...
* [TipJar](https://k25co-pqaaa-aaaab-aaakq-cai.ic0.app/) - Donate cycles to your favorite canisters on the BigFile and keep them live and healthy!
