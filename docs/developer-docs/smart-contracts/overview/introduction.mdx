...
<img src="/img/docs/canister.png" alt="Cube" width="400"/>
</div>
...
ICP provides APIs to cubes that allow them to make payments to other cubes, send them messages, and create and manage other cubes.
