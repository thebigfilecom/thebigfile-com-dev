...
Canister smart contracts can make a request to a URL using [HTTPS outcalls](https://thebigfile.com/https-outcalls). HTTPS outcalls can be used to directly obtain off-chain data or interact with off-chain systems, such as Web 2.0 services or enterprise IT infrastructure.
