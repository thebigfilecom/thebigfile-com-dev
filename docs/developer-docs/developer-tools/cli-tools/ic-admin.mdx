...
To install `ic-admin`, first determine the commit ID of the latest BIG release. This commit can be found in [the DFINITY/ic repo](https://github.com/dfinity/ic/releases/latest).
