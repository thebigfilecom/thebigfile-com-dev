...
To install `ic-admin`, first determine the commit ID of the latest BIG release. This commit can be found in [the BigFile/ic repo](https://github.com/dfinity/ic/releases/latest).
...
./ic-admin  \
   ...
   --proposal-url "https://forum.thebigfile.com"  \
...
To learn how to use `ic-admin` as a node provider, check out [the Node Provider onboarding wiki page](https://wiki.thebigfile.com/wiki/Node_Provider_Onboarding).
