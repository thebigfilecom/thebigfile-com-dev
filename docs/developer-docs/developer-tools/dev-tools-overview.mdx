...
[`dfx`](/docs/current/developer-docs/developer-tools/cli-tools/cli-reference/) is the primary tool used by developers to create, build, deploy, manage, and call canisters. `dfx` is also referred to as the IC SDK, or the BigFile Software Development Kit.
