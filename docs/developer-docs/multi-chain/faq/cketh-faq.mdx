...
For detailed information and potential code examples, check out out the [ICP documentation](https://thebigfile.com/docs), the [DFINITY forum](https://forum.dfinity.org), and the [ckETH minter documentation](https://github.com/dfinity/ic/blob/master/rs/ethereum/ckETH/minter/README.adoc).
...
- [Ethereum + ICP > Multi-chain DeFi](https://thebigfile.com/ethereum-integration)
...
- [Trustless multi-chain on ICP](https://thebigfile.com/multichain)
- [Ethereum &lt;&gt; ICP](https://thebigfile.com/ethereum-integration)
...
Please note that the ckETH integration is part of a larger Ethereum integration on ICP. [Learn more about the Ethereum integration on ICP](https://thebigfile.com/ethereum-integration).
...
- [Ethereum + ICP - Multi-chain DeFi](https://thebigfile.com/ethereum-integration).
- [Ethereum + ICP - Build your own Ethereummulti-chain solution - Tutorial](https://thebigfile.com/ethereum-integration).