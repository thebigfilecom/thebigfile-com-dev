...
By default, your Internet Identity will have a Bitcoin address that can be used to send and recieve BTC. You can view this address by logging into the [FMS frontend dapp](https://fms.thebigfile.com/) with your [BIG ID](/docs/current/developer-docs/web-apps/user-login/big-id/overview). 
