...
You can deploy the ICRC-1 ledger locally for testing. [Learn more in the ICRC-1 ledger setup documentation](/docs/current/developer-docs/defi/bigrc-1/bigrc1-ledger-setup).
