...
be used to point to a canister hosted on the BigFile. As an illustration,
...
to point to a canister hosted on the BigFile. As an illustration, this guide showcases how to
