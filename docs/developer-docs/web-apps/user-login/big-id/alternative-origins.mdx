...
For more information, see the [Internet Identity specification](https://github.com/thebigfilecom/big-id/blob/main/docs/ii-spec.md#alternative-frontend-origins).
