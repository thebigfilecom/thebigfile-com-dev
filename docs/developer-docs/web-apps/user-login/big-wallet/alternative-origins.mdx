...
For more information, see the [Internet Identity specification](https://github.com/thebigfilecom/big-wallet/blob/main/docs/ii-spec.md#alternative-frontend-origins).
...
```json
{
  "alternativeOrigins": ["https://thebigfile.com"]
}
```
