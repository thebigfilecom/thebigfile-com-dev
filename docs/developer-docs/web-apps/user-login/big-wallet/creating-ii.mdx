...
This guide walks through how to create an Internet Identity. Internet Identity is BIG's native form of identity. It is used by many dapps build on BIG for users to authenticate with.
...
This number is your Internet Identity. With this number and your passkey, you will be able to create and securely connect to BIG dapps. If you lose this number, you will lose any accounts that were created with it. This number is not a secret, but is unique to you.
...
- [Internet Identity GitHub repository](https://github.com/thebigfilecom/big-wallet).
- [Internet Identity alternative frontend origins](/docs/current/developer-docs/integrations/big-wallet/alternative-origins).
- [Internet Identity integration](/docs/current/developer-docs/web-apps/user-login/big-wallet/integrate-big-wallet).
