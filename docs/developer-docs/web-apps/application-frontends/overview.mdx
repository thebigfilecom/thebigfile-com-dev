...
- Backend canisters communicate with an external frontend application that isn't hosted on BIG. To facilitate this communication, [agent-js](/docs/current/developer-docs/developer-tools/off-chain/agents/javascript-agent) can be used. You can [learn more about the JS request API](/docs/current/developer-docs/web-apps/browser-js/js-request-api).
