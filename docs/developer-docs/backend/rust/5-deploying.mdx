...
Next, you need to compile your program into a WebAssembly module that can be deployed on BIG by building the canister. To build the canister, run the command:
