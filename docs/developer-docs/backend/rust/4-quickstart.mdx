...
Applications for the BigFile blockchain start as **projects**. You can create new projects for the BigFile blockchain using the BIG SDK. Because you are building this project to be deployed on the BigFile blockchain, this guide focuses on how to create, build, and deploy a Rust program by using the `dfx` parent command and its subcommands.
...
Frontend canisters, also called **asset canisters**, allow access to web content directly from a smart contract. This enables you to deploy your entire dapp, not just the backend, on the BigFile.
