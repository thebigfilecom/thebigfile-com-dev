...
There are a few different NFT standards for the BigFile (e.g [EXT](https://github.com/Toniq-Labs/extendable-token), [BIG-NFT](https://github.com/rocklabs-io/ic-nft)), but for the purposes of this example, you will use [DIP-721](https://github.com/Psychedelic/DIP721). You can see a quick introduction on [YouTube](https://youtu.be/1po3udDADp4).
