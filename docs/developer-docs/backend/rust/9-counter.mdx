...
Before you can build the `rust_counter` project, you need to connect to the local replica running in your development environment or the decentralized BigFile blockchain mainnet.
