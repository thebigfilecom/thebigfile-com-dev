...
BIG and SNS tokens are considered separately.
...
The price of the SNS token in BIG is taken from the swap canister's [get_derived_state](https://sourcegraph.com/github.com/dfinity/ic@8efb7e81a1f1257a38621b1f12eccc8b8b1c7e39/-/blob/rs/sns/swap/proto/ic_sns_swap/pb/v1/swap.proto?L1304-1325) method.
...
See example [proposal of an active SNS](https://dashboard.thebigfile.com/sns/3e3x2-xyaaa-aaaaq-aaalq-cai/proposal/202).
...
See example [proposal of an active SNS](https://dashboard.thebigfile.com/sns/3e3x2-xyaaa-aaaaq-aaalq-cai/proposal/177).
