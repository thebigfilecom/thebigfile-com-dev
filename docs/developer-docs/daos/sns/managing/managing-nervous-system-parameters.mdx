...
See example [proposal of an active SNS](https://dashboard.thebigfile.com/sns/7jkta-eyaaa-aaaaq-aaarq-cai/proposal/6).
...
By default, [maturity modulation](https://wiki.thebigfile.com/wiki/Maturity_modulation) is enabled; however, an SNS can use this
