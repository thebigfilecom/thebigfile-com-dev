...
For instructions on how to install the ICRC-1 Ledger follow [ICRC-1 Ledger Deployment](/docs/current/developer-docs/defi/bigrc-1/bigrc1-ledger-setup).
For instructions on how to interact with the ICRC-1 Ledger follow [ICRC-1 Ledger Interaction](/docs/current/developer-docs/defi/bigrc-1/using-bigrc1-ledger).
