...
## Overview
All changes to the configuration and behavior of the BigFile are controlled by an algorithmic governance system called the Network Nervous System (NNS). The NNS controls all aspects of the BigFile blockchain configuration and is responsible for performing many network management operations. For example, the Network Nervous System (NNS) is responsible for:
...
To connect to the BigFile using the Network Nervous System (NNS) dapp:
...
The destination address can be an address in the ledger canister running on the BigFile network, an account you have added using the [Network Nervous System dapp](https://nns.ic0.app), or the address for a wallet you have on an exchange.

If you transfer the BIG utility tokens to an account in the [Network Nervous System dapp](https://nns.ic0.app), you might need to refresh the browser to see the transaction reflected.
