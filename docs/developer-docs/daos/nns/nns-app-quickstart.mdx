...
- #### Step 2:  Look up the transaction in the BigFile Association [transaction dashboard](https://dashboard.internetcomputer.org/transactions) to get the neuron address.
...
- #### Step 3: Then, enter the amount of BIG tokens and cycles to create the canister with. Then select **Review Canister Creation**.
