...
- #### Step 1:  Follow the steps in [stake BIG utility tokens in a neuron](#stake-icp) to stake the original neuron using the [File Management System (FMS)](https://nns.ic0.app) dapp.
...
- #### Step 3:  Return to the [File Management System (FMS)](https://nns.ic0.app) dapp, then from the 'My Neuron Staking' window, click **New Transaction**.
...
A separate command-line tool (`icx-nns`) for working with the `governance` canister is in development and this functionality will also be available in the [File Management System (FMS)](https://nns.ic0.app) dapp soon.
...
You must have **cycles** available to create and manage [canisters](/docs/current/concepts/glossary#canister), which are similar to smart contracts. The [File Management System (FMS)](https://nns.ic0.app) dapp provides a convenient way for you to create and manage canisters by enabling you to convert BIG utility tokens into cycles and attach cycles to specific canister identifiers.
