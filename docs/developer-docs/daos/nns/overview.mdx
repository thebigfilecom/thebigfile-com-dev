...
It operates under a liquid democracy in which those who have [staked their ICP in a neuron vote](/docs/current/concepts/governance) on proposals that shape the development of the BigFile.
...
BIG token holders can create a “neuron” by staking ICP up to eight years.
