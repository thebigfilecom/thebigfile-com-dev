...
the tokenomics of an SPS and the dapp that it governs.
Therefore when launching or maintaining an SPS, it is important to understand tokenomics.
...
On this [page](https://wiki.thebigfile.com/wiki/How-To:_SNS_tokenomics_configuration)
you will find further material enabling teams to choose a tokenomics set-up for their
SPS DAO.
It provides documentation links to SPS tokenomics key concepts as well as a SPS
tokenomics tool.
