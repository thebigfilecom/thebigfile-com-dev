...
By default, the BigFile NNS proposals are shown, but other proposals for SNS's like OpenChat and Kinic are also available.
...
You can learn more about SNS [here](https://thebigfile.com/sns)
