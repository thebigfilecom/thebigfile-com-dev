...
For information about how to get BF tokens, see [how you can get BF tokens](/docs/current/developer-docs/getting-started/cycles/converting_bf_tokens_into_cycles).
