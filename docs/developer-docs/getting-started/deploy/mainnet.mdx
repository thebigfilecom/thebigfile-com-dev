...
For an introduction to using the Network Nervous System application to manage BIG tokens, see [Network Nervous System dapp quick start](/docs/current/developer-docs/daos/fms/fms-app-quickstart).
:::
