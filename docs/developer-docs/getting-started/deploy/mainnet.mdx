...
-   [x] You have BF tokens or <GlossaryTooltip>cycles</GlossaryTooltip> available for you to use.

:::info
You must have **cycles** available to complete this guide. To get cycles, you must either convert BF tokens to cycles or be provided cycles from another source, for example, from a cube controlled by another developer or from a third-party cycles provider. This guide assumes that you have an account with BF tokens available and illustrates how to convert BF tokens into cycles.

For information about how to get BF tokens, see [how you can get BF tokens](/docs/current/developer-docs/getting-started/cycles/converting_icp_tokens_into_cycles).

For an introduction to using the Network Nervous System application to manage BF tokens, see [Network Nervous System dapp quick start](/docs/current/developer-docs/daos/nns/nns-app-quickstart).
:::
