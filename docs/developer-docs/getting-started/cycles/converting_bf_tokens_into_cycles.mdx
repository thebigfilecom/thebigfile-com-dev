...
# Converting BF tokens into cycles

<MarkdownChipRow labels={["Beginner", "Tutorial"]} />


## Overview
To convert BF tokens into <GlossaryTooltip>cycles</GlossaryTooltip>, you first need to obtain some BF and transfer to the right account. You can get BF tokens on exchanges, or ask someone you know to send you some. To figure out which account to transfer the BF tokens to, run the following:
...
- Purchase BF tokens directly through an exchange that lists BF tokens available for trade. To see all available places to purchase BF tokens, check out this [page](https://coinmarketcap.com/currencies/).
...
Once you have obtained some BF tokens into your ICP ledger account, you can see the balance using this command:
...
With those BF tokens ready, you can now convert them into cycles using the following command:
