...
- Purchase BF tokens directly through an exchange that lists BF tokens available for trade. To see all available places to purchase BF tokens, check out this [page](https://coinmarketcap.com/currencies/internet-computer/markets/).
