...
A **wallet** on BIG is used to store <GlossaryTooltip>cycles</GlossaryTooltip> that can be sent to <GlossaryTooltip>cubes</GlossaryTooltip> to pay for their consumed resources.
...
- Receive a grant of tokens through the BigFile Association (ICA) or the DFINITY Foundation.
