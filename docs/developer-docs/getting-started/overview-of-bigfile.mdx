...
BigFile has an equivalent of the ERC-20 standard, called [BIGRC-20](https://github.com/thebigfilecom/BIGRC-20/blob/main/standards/BIGRC-20/README.md).
If a smart contract implements BIGRC-20, then it implements a fungible token and has a ledger for it.
