...
Select 'Continue with BIG ID'. In the new window, select the BIG ID you'd like to use:
...
- Authentication: Enable or disable authentication methods such as NFID and BIG ID.
