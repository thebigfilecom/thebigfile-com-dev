...
![BIG tokens how to use](_attachments/icp-tokens-how-to-use.svg)
...
To learn more about cycles and how to use them, see [here](/docs/current/developer-docs/getting-started/cycles/converting_big_tokens_into_cycles).
