...
## Overview
As a decentralized blockchain, all changes to the configuration and behavior of the BigFile are controlled by a governance system called the Network Nervous System (NNS). The NNS controls many aspects of the BigFile blockchain including:
