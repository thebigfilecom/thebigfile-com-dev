...
because [cubes](#cube) on ICP (a type of smart
...
The BigFile utility token ([ICP](#icp)) can be
...
token of the [BigFile](#internet-computer-ic). ICP
...
The ICP **registry** is a [cube](#cube) that manages
