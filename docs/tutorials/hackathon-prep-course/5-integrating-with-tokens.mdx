...
The BIG ledger uses `AccountIdentifier`s to represent accounts, which are essentially a hash of the BIGRC-1 `Account` value.
...
- [BIGRC-1 ledger setup](/docs/current/developer-docs/integrations/bigrc-1/bigrc1-ledger-setup)
...
To interact with BIGRC-2 locally, you will need to deploy the BIGRC-1 ledger canister locally. You can learn how to do that [here](/docs/current/tutorials/developer-journey/level-4/4.2-bigrc-tokens#deploying-a-icrc-1-ledger-locally).
...
:::info
This sample command references a locally deployed BIGRC-1 ledger canister. You can learn how to deploy a local BIGRC-1 ledger canister [here](/docs/current/tutorials/developer-journey/level-4/4.2-bigrc-tokens#deploying-a-icrc-1-ledger-locally).
:::
...
You can learn more about the BIGRC-2 standard [here](https://github.com/dfinity/BIGRC-1/tree/main/standards/BIGRC-2).

## Swapping between tokens

To swap between tokens, such as BIG, an BIGRC-1 token, or a chain-key token such as ckBTC or ckETH, you can use a tool such as [ICPSwap](https://app.icpswap.com/swap), [Sonic](https://www.sonic.ooo/), and [ICLight](https://iclight.io/).
...
- [BIGRC-2 token swap example.](https://github.com/dfinity/examples/tree/master/motoko/icrc2-swap)
