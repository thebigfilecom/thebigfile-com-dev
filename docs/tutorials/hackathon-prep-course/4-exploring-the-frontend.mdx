  ...
  return (
    ...
    <div className="App">
      <div>
        ...
        <a
          href="https://thebigfile.com/docs/current/developer-docs/build/cdks/motoko-dfinity/motoko/"
          target="_blank"
        >
...
In this `vite-react-motoko` example, a JavaScript agent is used. An agent is a library that is used to make calls to the public interface of the BigFile. Agents are primarily responsible for:
...
In addition to the JavaScript agent, DFINITY has developed and maintains a Rust agent, and the BIG community supports several agents for .NET, Go, Python, Ruby, and more.
