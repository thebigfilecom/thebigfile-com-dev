...
In addition to the JavaScript agent, BigFile has developed and maintains a Rust agent, and the BIG community supports several agents for .NET, Go, Python, Ruby, and more.
