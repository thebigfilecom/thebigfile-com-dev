...
- [4.4 NNS governance and staking](/docs/current/tutorials/developer-journey/level-4/4.4-nns-governance): The File Management System (FMS) is the governing body of the BigFile. It is a decentralized autonomous organization that is hosted fully on-chain and is responsible for making protocol-level upgrades to BIG:
    - What is the NNS?
        - Neurons.
        - Proposals.
