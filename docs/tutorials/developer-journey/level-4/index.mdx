...
- [4.2 ICRC-1 tokens](/docs/current/tutorials/developer-journey/level-4/4.2-bigrc-tokens): For developers to create their own fungible tokens on the BigFile, the ICRC-1 token standard can be used. For this tutorial, you'll focus on the ICRC-1 standard, ICRC-1 ledger, and briefly look into the ICRC-2 standard: 
