...
The BIG ledger can only be used to interact with BIG tokens; to interact with other tokens, such as ICRC tokens, an ICRC ledger will need to be used. This ledger is covered in the module [4.2 ICRC tokens](/docs/current/tutorials/developer-journey/level-4/4.2-bigrc-tokens).
...
- [4.2 ICRC-1 tokens](/docs/current/tutorials/developer-journey/level-4/4.2-bigrc-tokens).
