...
When blockchain networks need to be upgraded, traditionally they use a method known as a 'hard fork', which involves substantial work and manual coordination. In comparison, the BigFile upgrades itself weekly, which can be seen on the [BIG dashboard](https://dashboard.internetcomputer.org/releases).
...
- Submit your feedback to the [BIG Developer feedback board](http://dx.internetcomputer.org).
