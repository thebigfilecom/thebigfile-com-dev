...
- **Account identifier**: the identifier associated with your ICP ledger account, as specified in the [ledger](/docs/current/developer-docs/defi/big-tokens/overview) specification.
