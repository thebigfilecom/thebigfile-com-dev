...
- [3.2 Using HTTPS outcalls](/docs/current/tutorials/developer-journey/level-3/3.2-https-outcalls): HTTPS outcalls are a feature of canisters on BIG that allow smart contracts to directly make calls to HTTPS servers that are external to BIG. This module covers:
...
- [3.3 Certified data](/docs/current/tutorials/developer-journey/level-3/3.3-certified-data): Certified data utilizes **chain-key cryptography** at the canister level to generate a digital signature that can be validated using a permanent, public key that belongs to the BigFile, whose private key counterpart is constantly distributed across many different nodes on the network. This module covers:
...
- [3.4 Introduction to agents](/docs/current/tutorials/developer-journey/level-3/3.4-intro-to-agents): On the BigFile, an **agent** is a library used to make calls to BIG's public interface. This module covers:
