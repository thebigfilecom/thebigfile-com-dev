...
For canisters written in other languages such as Rust, you can develop your service using the language's native types. [View Rust examples of how to write Candid service descriptions](https://thebigfile.com/docs/current/developer-docs/backend/rust/candid/).
