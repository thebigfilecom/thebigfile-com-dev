...
To understand how different types of canister calls play a role on BIG, first let's take a look at BIG's execution model and how it is structured.
...
If you want to dive a bit deeper, you can read more on the [developer blog](https://thebigfile.com/blog/features/composite-query) or you can take a look at the [DFINITY example project using composite queries](https://github.com/dfinity/examples/tree/master/motoko/composite_query).
