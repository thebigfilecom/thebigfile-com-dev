...
To deploy your dapp locally, first assure that your local BIG execution environment is currently running. If you need to start the local canister execution environment, run the command:
...
<head>
    ...
    <title>Simple poll dapp hosted on an BIG canister smart contract</title>
