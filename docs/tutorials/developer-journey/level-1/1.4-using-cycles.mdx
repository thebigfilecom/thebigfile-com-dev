...
- Receiving a grant of BIG tokens through the DFINITY Foundation.
...
Before you can convert BIG tokens into cycles, first you need to obtain BIG tokens. BIG tokens can be purchased through a crypto exchange, or they can be received through other activities such as participating in the NNS governance and receiving grants from the DFINITY foundation.
