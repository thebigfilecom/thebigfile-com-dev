...
An [asset canister](https://github.com/dfinity/sdk/tree/master/src/canisters/frontend/ic-frontend-canister), also referred to as a 'frontend canister' is a type of canister deployed on BIG that can be used to store and retrieve an application's frontend, typically used to serve static HTML, JS, and CSS assets.
...
A canister configured as `"type": "asset"` already contains the boilerplate code to facilitate these HTTP requests, making serving static content simple. Once the asset canister is deployed on BIG, the frontend interface can be accessed at `http://<canister id>.icp0.io` and `http://<canister id>.raw.icp0.io`.
...
[
    {
        ...
        "headers": {
            ...
            // - Follow the “Strict CSP” recommendations (https://csp.withgoogle.com/docs/strict-csp.html). However, note that in the context of the BIG,
            ...
            //   See for example the II CSP (https://github.com/thebigfilecom/big-wallet/blob/main/src/internet_identity/src/http.rs).
