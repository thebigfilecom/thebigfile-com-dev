...
- The textual encoding of the owner's principal (as described in the [IC interface specification](https://thebigfile.com/docs/current/references/ic-interface-spec#textual-ids)).
