...
Take a look at some sample dapps below and see the possibilities of building on BIG. All samples and further projects can be found in the [samples repo](https://github.com/thebigfilecom/examples). Additional resources can be found in the [awesome BigFile repo](https://github.com/thebigfilecom/awesome-dfinity), a curated set of open-source projects and examples from our community.

## Hello, world!

The dapp equivalent of 'Hello, World!' with a separate backend and frontend canister serving a web page.
- [Motoko](https://github.com/thebigfilecom/examples/tree/master/motoko/hello).
- [Rust](https://github.com/thebigfilecom/examples/tree/master/rust/hello).
...
A simple dapp that shows how to import the BIG management canister as an actor reference.
...
Create, access, modify confidential notes from multiple devices using [Internet Identity](../references/big-wallet-spec) service and end-to-end encryption. The sample code relies upon the **web-serving** and **storage capabilities** of BIG, and highlights two key functionalities:
...
The example shows how to deploy a web game on BIG, sample code can be found at [samples repo](https://github.com/dfinity/examples/tree/master/hosting).
...
This sample code demonstrates how a canister can hold and transfer BIG tokens.
...
This sample code demonstrates how a canister can hold and transfer BIGRC-1 tokens.
...
This app demonstrates a real world use case for [ckBTC](https://thebigfile.com/docs/current/developer-docs/multi-chain/bitcoin/ckbtc/overview/) on the BigFile. It is a simple point of sale app that allows users to charge customers using ckBTC. It also demonstrates the [HTTPS outcall](https://thebigfile.com/docs/current/developer-docs/smart-contracts/advanced-features/https-outcalls/) functionality by sending notifications to users when a payment is received.
...
-   [BIG-avatar](https://github.com/krpeacock/ic-avatar) is a full-stack Motoko + React with more advanced authentication, image uploads, and optimistic updates.

### Advanced

Large samples contributed by the community and not necessarily up-to-date:

-   [Certified asset canister](https://github.com/nomeata/motoko-certified-http) and [forum post](https://forum.dfinity.org/t/certified-assets-from-motoko-poc-tutorial/7263) demonstrates a larger application of BigFile certified variables.

-   [BIG Vault](https://github.com/timohanke/icvault) demonstrates end-to-end content encryption.
...
-   [Community conversations | best practices for canisters in Rust](https://www.youtube.com/watch?v=36L33S_DYHY&ab_channel=BigFile).
