...
Create, access, modify confidential notes from multiple devices using [Internet Identity](../references/big-id-spec) service and end-to-end encryption. The sample code relies upon the **web-serving** and **storage capabilities** of BIG, and highlights two key functionalities:
...
-   [Certified asset canister](https://github.com/nomeata/motoko-certified-http) and [forum post](https://forum.thebigfile.com/t/certified-assets-from-motoko-poc-tutorial/7263) demonstrates a larger application of BigFile certified variables.
