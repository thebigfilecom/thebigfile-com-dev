...
const Constants = {
  ...
  urlInternetComputerStatus: 'https://bigfile.statuspage.io/',
  urlInternetComputerStatusApi: 'https://status.thebigfile.com/api/v2',
  urlNnsDapp: 'https://nns.ic0.app',
  urlRouteIdSnsRootCanisterId: 'snsRootCanisterId',
  urlWikiMaturityModulation: 'https://wiki.thebigfile.com/wiki/Maturity_modulation',
  urlWikiNodeMachineHardware: 'https://wiki.thebigfile.com/wiki/Node_Machine_Hardware',
